...
export default function Home() {
  const postManagerContract = "0xA5dcF7a84CAbD95FA28dCa33d46015eD1B7Ff1e8"; //postManager smart contract address
  ...
  async function getWeb3StorageAPIkey() {
    const key = process.env.NEXT_PUBLIC_WEB3_STORAGE_API_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweGUyODc5ZUQ3OGFFMTEwMTJmNkZkRjdGOTk3ODViM0VCOGI4NTVFRGYiLCJpc3MiOiJ3ZWIzLXN0b3JhZ2UiLCJpYXQiOjE2Nzk4OTE3NjY2MTksIm5hbWUiOiJUb2tlbiJ9.XZXzMm509Fh6g26QJ5e6WmOIBqN1_vyZZg8D8FhCZnU';
    if (key != undefined) {
      setToken(key);
    }
  }
